...
public class Receiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intentAction.equals(Intent.ACTION_BOOT_COMPLETED)){
			...
			if (intentAction.equals(ACTION_DATA_STATE_CHANGED)) {
				...
				// Re-register when a Wi-Fi connection is made (and WLAN mode is enabled)
				if (intentAction.equals(WifiManager.SUPPLICANT_CONNECTION_CHANGE_ACTION)) {
	...
	public static void setAudioModeInCall(boolean val) {
		AudioManager audio_service = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE);
